...
**
** Created: Mon Feb 11 13:37:39 2013
...
public:
    ...
    QPushButton *moveWithBallBtn;
    QPushButton *NavToBallBtn;
    QPushButton *stopBtn;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        moveWithBallBtn = new QPushButton(groupBox);
        moveWithBallBtn->setObjectName(QString::fromUtf8("moveWithBallBtn"));

        verticalLayout_2->addWidget(moveWithBallBtn);

        NavToBallBtn = new QPushButton(groupBox);
        NavToBallBtn->setObjectName(QString::fromUtf8("NavToBallBtn"));

        verticalLayout_2->addWidget(NavToBallBtn);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        moveWithBallBtn->setText(QApplication::translate("MainWindow", "Dribble ", 0, QApplication::UnicodeUTF8));
        NavToBallBtn->setText(QApplication::translate("MainWindow", "Move To Ball", 0, QApplication::UnicodeUTF8));
